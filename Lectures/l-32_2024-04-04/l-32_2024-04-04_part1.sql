...
select * from customers where customerName like "%a_"; -- მონიშნავს ყველა კლინეტს, სადაც customerName-ში ბოლოს წინა ასო არის a.

select * from customers where customerName like "%a__"; -- მონიშნავს ყველა კლინეტს, სადაც customerName-ში ბოლოდან მესამე ასო არის a.

select * from customers where customerName not like "%gift%";  -- მონიშნავს ყველა კლინეტს, სადაც customerName არ შეიცავს სიტყვა gift-ს.
